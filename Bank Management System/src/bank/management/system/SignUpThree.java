...
public class SignUpThree extends JFrame implements ActionListener{
	...
	SignUpThree(String formno){
		...
		c7=new JCheckBox("Hereby declare that the above entered details are correct to the best of the knowledge ");
		c7.setBackground(Color.WHITE);
		c7.setFont(new Font("Raleway",Font.BOLD,12));
		c7.setBounds(100,640,550,30);
		add(c7);
		...
		if(ae.getSource()==submit) {
			...
			try {
				if(accountType.equals("")) {
					...
					setVisible(false);
					new Deposit(pinnumber).setVisible(false);//cannot open account with balance as 0
